...
*/
Riscduino_ST7735::Riscduino_ST7735(int8_t cs, int8_t dc, int8_t mosi, int8_t sclk,
                                 int8_t rst)
    : Riscduino_ST77xx(ST7735_TFTWIDTH_128, ST7735_TFTHEIGHT_160, cs, dc, mosi,
                      sclk, rst) {}
...
/*!
    ...
    @param  rst  Reset pin # (optional, pass -1 if unused)
*/
Riscduino_ST7735::Riscduino_ST7735(int8_t cs, int8_t dc, int8_t rst)
    : Riscduino_ST77xx(ST7735_TFTWIDTH_128, ST7735_TFTHEIGHT_160, cs, dc, rst) {}
...
/*!
    ...
    @param  rst       Reset pin # (optional, pass -1 if unused)
*/
Riscduino_ST7735::Riscduino_ST7735(SPIClass *spiClass, int8_t cs, int8_t dc,
                                 int8_t rst)
    : Riscduino_ST77xx(ST7735_TFTWIDTH_128, ST7735_TFTHEIGHT_160, spiClass, cs,
                      dc, rst) {}
...
*/
/**************************************************************************/
void Riscduino_ST7735::initB(void) {
  commonInit(Bcmd);
  setRotation(0);
}
...
*/
/**************************************************************************/
void Riscduino_ST7735::initR(uint8_t options) {
  commonInit(Rcmd1);
...
*/
/**************************************************************************/
void Riscduino_ST7735::setRotation(uint8_t m) {
  uint8_t madctl = 0;
