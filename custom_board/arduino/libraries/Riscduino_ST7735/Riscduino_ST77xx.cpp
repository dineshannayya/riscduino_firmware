...
*/
/**************************************************************************/
Riscduino_ST77xx::Riscduino_ST77xx(uint16_t w, uint16_t h, int8_t cs, int8_t dc,
                                 int8_t mosi, int8_t sclk, int8_t rst,
                                 int8_t miso)
    : Riscduino_SPITFT(w, h, cs, dc, mosi, sclk, rst, miso) {}
...
Riscduino_ST77xx::Riscduino_ST77xx(uint16_t w, uint16_t h, int8_t cs, int8_t dc,
                                 int8_t rst)
    : Riscduino_SPITFT(w, h, cs, dc, rst) {}
...
*/
/**************************************************************************/
Riscduino_ST77xx::Riscduino_ST77xx(uint16_t w, uint16_t h, SPIClass *spiClass,
                                 int8_t cs, int8_t dc, int8_t rst)
    : Riscduino_SPITFT(w, h, spiClass, cs, dc, rst) {}
#endif // end !ESP8266
...
*/
/**************************************************************************/
void Riscduino_ST77xx::displayInit(const uint8_t *addr) {
...
*/
/**************************************************************************/
void Riscduino_ST77xx::begin(uint32_t freq) {
  if (!freq) {
...
*/
/**************************************************************************/
void Riscduino_ST77xx::commonInit(const uint8_t *cmdList) {
  begin();
...
*/
/**************************************************************************/
void Riscduino_ST77xx::setAddrWindow(uint16_t x, uint16_t y, uint16_t w,
                                    uint16_t h) {
  x += _xstart;
  y += _ystart;
...
*/
/**************************************************************************/
void Riscduino_ST77xx::setRotation(uint8_t m) {
  uint8_t madctl = 0;
...
*/
/**************************************************************************/
void Riscduino_ST77xx::setColRowStart(int8_t col, int8_t row) {
  _colstart = col;
  _rowstart = row;
}
 ...
 */
/**************************************************************************/
void Riscduino_ST77xx::enableDisplay(boolean enable) {
 ...
 */
/**************************************************************************/
void Riscduino_ST77xx::enableTearing(boolean enable) {
 ...
 */
/**************************************************************************/
void Riscduino_ST77xx::enableSleep(boolean enable) {
...
/*
 ...
 uint8_t Riscduino_ST77xx::spiread(void) {
 uint8_t r = 0;
 if (_sid > 0) {
 ...
 void Riscduino_ST77xx::dummyclock(void) {
 ...
 uint8_t Riscduino_ST77xx::readdata(void) {
 ...
 *portOutputRegister(csport) |= cspin;
 ...
 uint8_t Riscduino_ST77xx::readcommand8(uint8_t c) {
 ...
 *portOutputRegister(csport) |= cspin;
 ...
 uint16_t Riscduino_ST77xx::readcommand16(uint8_t c) {
 digitalWrite(_rs, LOW);
 if (_cs)
 ...
 uint32_t Riscduino_ST77xx::readcommand32(uint8_t c) {
 digitalWrite(_rs, LOW);
 if (_cs)
 digitalWrite(_cs, LOW);
 spiwrite(c);
