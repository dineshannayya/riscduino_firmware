...
#define GLBL_SOFT_REG2   (0x20)  // Software Reg-2
#define GLBL_SOFT_REG3   (0x24)  // Software Reg-3
#define GLBL_SOFT_REG4   (0x28)  // Software Reg-4
#define GLBL_SOFT_REG5   (0x2C)  // Software Reg-5
